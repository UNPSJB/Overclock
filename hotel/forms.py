...
class TemporadaHotelForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['nombre'].widget.attrs.update({'class': 'form-control'})  
        self.fields['inicio'].widget.attrs.update({'class': 'form-control DateTimeInput'},  input_formats=('%m/%d/%Y', ))
        self.fields['fin'].widget.attrs.update({'class': 'form-control DateTimeInput'},  input_formats=('%m/%d/%Y', ))
